...
public class RecordingProvider extends ContentProvider
{
    ...
    public static final Uri CONTENT_URI = Uri.parse(BASE_PATH);
    ...
    static {
        ...
        uriMatcher.addURI("flynn.pro.flatears", "records", RECORDINGS);
        uriMatcher.addURI("flynn.pro.flatears", "records/#", RECORDING_ID);
    }
